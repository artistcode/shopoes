...
if (defined('JOURNAL3_ACTIVE')) {
		...
		if ($category_info) {
            ...
            if (defined('JOURNAL3_ACTIVE')) {
                if ($result['image']) {
                    $image2x = $this->model_journal3_image->resize($result['image'], $this->journal3->themeConfig('image_product_width') * 2, $this->journal3->themeConfig('image_product_height') * 2, $this->journal3->themeConfig('image_product_resize'));
                } else {
                    $image2x = $this->model_journal3_image->resize('placeholder.png', $this->journal3->themeConfig('image_product_width') * 2, $this->journal3->themeConfig('image_product_height') * 2, $this->journal3->themeConfig('image_product_resize'));
                }
                ...
                if ($this->journal3->document->isDesktop() && $this->journal3->settings->get('globalProductGridSecondImageStatus') && ($additional_image = $this->journal3->productSecondImage($result))) {
                    $second_image = $this->model_journal3_image->resize($additional_image, $this->journal3->themeConfig('image_product_width'), $this->journal3->themeConfig('image_product_height'), $this->journal3->themeConfig('image_product_resize'));
                    $second_image2x = $this->model_journal3_image->resize($additional_image, $this->journal3->themeConfig('image_product_width') * 2, $this->journal3->themeConfig('image_product_height') * 2, $this->journal3->themeConfig('image_product_resize'));
                } else {
                    $second_image = false;
